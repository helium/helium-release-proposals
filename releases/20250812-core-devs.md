...
This document defines the release that will be deployed on or before August 19th, 2025. As features are discussed in the community and developed by Helium Core Developers, this release document will be updated with context and explicit details on implementation.
...
### (2) Add Serial Number for Helium Mobile Wi-Fi Hotspots On-chain
