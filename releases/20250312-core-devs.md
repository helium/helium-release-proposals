...
This change will have no effect on any hex that is also a service provider boosted hex([HIP 84][hip-84]) as those hexes already override HIP-103 multipliers with a hardcoded value of 1.0.
