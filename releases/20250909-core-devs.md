...
As part of calculating Coverage Points for Hotspots, the Mobile Verifier uses a Coverage Template for each type of Mobile Hotspot. The indoor Hotspots uses a simple single hex, whereas the outdoor Hotspot uses a wedge-shaped Coverage Template that covers 120 degrees with a certain distance. 
...
As part of prioritizing Mobile Data over Proof of Coverage (PoC), [HIP-147](https://github.com/helium/HIP/blob/67ba7d337e5ddedfb0aabaf1734a4bb34d326399/0147-mobile-data-eats-first.md) proposes to reward hotspots for data first out of the combined Data and PoC rewards pool. Any remaining rewards are then applied to PoC. 

This will be implemented in this release **only if** HIP-147 passes. 
