...
Tuktuk claiming is slightly more expensive than manual claims, so users will pay a small additional fee. This fee is around 10000 lamports per position per transaction. Over a year, this will add up to 0.00365 SOL, which is less than $1 at current SOL prices.
